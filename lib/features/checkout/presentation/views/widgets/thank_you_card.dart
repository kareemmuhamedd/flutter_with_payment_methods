...
import 'package:flutter_paypal_stripe/core/utils/styles.dart';
import 'package:flutter_paypal_stripe/features/checkout/presentation/views/widgets/payment_info_item.dart';
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            const TotalPrice(title: 'Total', value: 'EGP 100.00'),
            const SizedBox(
              height: 30,
            ),
